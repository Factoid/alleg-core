...
#else
            m_preferredPartTypes.push_back(ppt);
#endif
        }
    }
...
#else
    m_poIcon.reset( pigc->LoadRadarIcon(m_data->iconName) );
#endif
...
#else
        m_phtSuccessor.reset( pMission->GetHullType(m_data->successorHullID) );
#endif
